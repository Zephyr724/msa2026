...
public static class DemoQuestSeed
{
    ...
    public static async Task SeedAsync(KiwimpactDbContext db)
    {
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111101",
            ...
            RegionSeed.HendersonMasseyId, "Henderson Creek Reserve",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111102",
            ...
            RegionSeed.DevonportTakapunaId, "Takapuna Beach Reserve",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111103",
            ...
            RegionSeed.AlbertEdenId, "Mt Albert Community Centre",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111104",
            ...
            RegionSeed.FranklinId, "Hunua Ranges",
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111105",
            ...
            RegionSeed.HowickId, "Howick Beach",
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111106",
            ...
            RegionSeed.KaipatikiId, "Glenfield Primary School",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111107",
            ...
            RegionSeed.GreatBarrierId, "Tryphena Beach",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111108",
            ...
            RegionSeed.MangereOtahuhuId, "Māngere Bike Path",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111109",
            ...
            RegionSeed.ManurewaId, "Manurewa Community Centre",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-11111111110A",
            ...
            RegionSeed.MaungakiekieTamakiId, "Tāmaki Wetland Reserve",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-11111111110B",
            ...
            RegionSeed.AucklandId, "Citywide",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-11111111110C",
            ...
            null, "Your backyard or local park",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-11111111110D",
            ...
            RegionSeed.OtaraPapatoetoeId, "Ōtara Youth Centre",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-11111111110E",
            ...
            RegionSeed.PapakuraId, "Papakura Transfer Station",
        ...
        await Seed(db, Q("11111111-1111-4111-8111-11111111110F",
            ...
            RegionSeed.NewZealandId, "Mt Roskill War Memorial Park",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111110",
            ...
            RegionSeed.RodneyId, "Rodney Coast",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111111",
            ...
            RegionSeed.UpperHarbourId, "Hobsonville Point",
            null, null, null, null,
            now,
        ...
        await Seed(db, Q("11111111-1111-4111-8111-111111111112",
            ...
            RegionSeed.WaihekeId, "Oneroa Beach",
            null, null, null, null,
            now,
