...
4. Observe `/health/ready` return healthy before Railway marks the deployment
   active.
5. Record the exact deployed Git SHA and Railway deployment ID.
6. Perform the smoke checks below. A green Railway badge alone is not release
   evidence.
