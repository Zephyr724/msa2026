  ...
  return (
    <main className="kiwi-page py-10">
      <header>
        ...
        <p className="mt-2 text-base-content/65">Private evidence is visible only in this review workflow.</p>
      </header>
      <div className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <section className="kiwi-panel p-5">
          ...
          {queue.data?.length === 0 && <p className="mt-4 text-base-content/60">Queue cleared.</p>}
        ...
        <section className="kiwi-panel p-5">
          {!selected && <div className="grid min-h-64 place-items-center text-base-content/55">Select a claim to review.</div>}
            ...
            <>
              <div className="flex items-start gap-3">
                ...
                <div><h2 className="text-2xl">{detail.data.questTitle}</h2>
                  <p className="text-sm text-base-content/55">Claim {detail.data.claimId}</p></div>
              </div>
